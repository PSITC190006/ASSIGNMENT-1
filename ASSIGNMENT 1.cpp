...
double price_of_printer=5000;
double price_of_phone=6000;
double price_of_table=7000;
...
cout<<" please what is your id number"<<endl;
cin>>customer_id;
cout<<endl;

cout<<"please what do you want to buy"<<endl;
cout<<"printer =5000"<<endl;
cout<<"phone =6000"<<endl;
cout<<"table =7000"<<endl;
cout<<endl;
